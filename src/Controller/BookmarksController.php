...
class BookmarksController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Bookmarks->save($bookmark)) {
                ...
                $this->Flash->success('El bookmarks se ha guardado.');
            ...
            $this->Flash->error('No se ha podido guardar el bookmarks. Por favor, inténtalo de nuevo.');
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Bookmarks->delete($bookmark)) {
            $this->Flash->success(__('El bookmarks ha sido eliminado.'));
        } else {
            $this->Flash->error(__('No se ha podido eliminar el bookmarks. Por favor, inténtelo de nuevo.'));
        }
