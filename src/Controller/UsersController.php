...
class UsersController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('No se ha podido guardar el usuario. Por favor, inténtelo de nuevo.'));
        }
        $this->set(compact('user'));
    }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Users->delete($user)) {
            ...
            $this->Flash->error(__('No se ha podido eliminar el usuario. Por favor, inténtelo de nuevo.'));
        }
