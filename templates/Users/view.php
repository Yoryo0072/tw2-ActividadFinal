...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(__('Eliminar User'), ['action' => 'delete', $user->id], ['confirm' => __('¿Estás seguro de que quieres borrar # {0}?', $user->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('Lista Users'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Bookmarks', 'action' => 'delete', $bookmarks->id], ['confirm' => __('¿Estás seguro de que quieres borrar # {0}?', $bookmarks->id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
