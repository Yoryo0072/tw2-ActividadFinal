...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(__('Eliminar Tag'), ['action' => 'delete', $tag->id], ['confirm' => __('¿Estás seguro de que quieres borrar # {0}?', $tag->id), 'class' => 'side-nav-item']) ?>
    ...
    <div class="column-responsive column-80">
        <div class="tags view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('Color') ?></th>
                    <td style="background-color: <?= h($tag->color) ?>;"></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
